    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.button5:
                ...
                Intent intent =new Intent(v.getContext(),LifeStyle.class);
            ...
            case R.id.button6:
                msg = "3";
                Intent i =new Intent(v.getContext(),Education.class);
            ...
            case R.id.button7:
                msg = "2";
                Intent it =new Intent(v.getContext(),Health.class);
            ...
            case R.id.button1:
                msg = "2";
                Intent itt =new Intent(v.getContext(),Eat.class);
                itt.putExtra("Message",msg);
                getActivity().startActivity(itt);
                break;
            case R.id.button2:
                msg = "2";
                Intent e =new Intent(v.getContext(),Imp_no.class);
                e.putExtra("Message",msg);
                getActivity().startActivity(e);
                break;
            case R.id.button3:
                msg = "2";
                Intent ie =new Intent(v.getContext(),Transport.class);
